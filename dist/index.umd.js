(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-apollo'), require('graphql-tag'), require('lodash/fp'), require('humps')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react-apollo', 'graphql-tag', 'lodash/fp', 'humps'], factory) :
	(factory((global['walless-graphql'] = {}),global.reactApollo,global.gql,global.fp,global.humps));
}(this, (function (exports,reactApollo,gql,fp,humps) { 'use strict';
...
var getDiets = reactApollo.graphql(gql(_templateObject4, dietFragment), {
  props: function props(_ref) {
    ...
    return {
      diets: (fp.get(['nodes'])(allDiets) || []).map(function (node) {
...
var getCurrencies = reactApollo.graphql(gql(_templateObject5, currencyFragment), {
...
var createAddress = reactApollo.graphql(gql(_templateObject$1, addressFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
			createAddress: function createAddress(address) {
				return mutate({ variables: {
						input: { address: Object.assign(fp.pick(['route', 'streetNumber', 'postalCode', 'country', 'coordinates', 'locality', 'placeId'])(address), address.lat && address.lng ? { coordinates: '(' + address.lat + ',' + address.lng + ')' } : {}) }
					} });
			}
		};
	}
...
var updateAccount = reactApollo.graphql(gql(_templateObject$3, accountFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
			updateAccount: function updateAccount(account) {
				return mutate({ variables: {
						input: { account: fp.omit(['__typename', 'nodeId'])(account) }
					} });
			}
		};
	}
...
var getImagesForRestaurant = reactApollo.graphql(gql(_templateObject3$3, imageFragment), {
  ...
  props: function props(_ref) {
    ...
    return {
      images: (fp.get(['imagesForRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
        return edge.node;
      }),
...
var getRestaurant = reactApollo.graphql(getRestaurantQuery, {
	skip: function skip(ownProps) {
...
var getActiveAccount = reactApollo.graphql(gql(_templateObject$4, accountFragment), {
	props: function props(_ref) {
		var ownProps = _ref.ownProps,
		    _ref$data = _ref.data,
...
var getRestaurantsByAccount = reactApollo.graphql(gql(_templateObject2$2, restaurantFragment), {
	skip: function skip(ownProps) {
		return _typeof(ownProps.account) === 'object' && !fp.get(['account', 'id'])(ownProps);
	},
	options: function options(ownProps) {
		return {
			variables: {
	...
	props: function props(_ref2) {
		...
		return {
			restaurants: (fp.get(['restaurantAccountsByAccount', 'edges'])(accountById) || []).map(function (edge) {
				return formatRestaurant(fp.get(['node', 'restaurantByRestaurant'])(edge));
			}),
...
var getAccountsByRestaurant = reactApollo.graphql(gql(_templateObject3$1, accountFragment), {
	skip: function skip(ownProps) {
		return !ownProps.restaurant;
	},
	options: function options(ownProps) {
	...
	props: function props(_ref3) {
		...
		return {
			accounts: (fp.get(['restaurantAccountsByRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
...
var getAccountRolesForRestaurant = reactApollo.graphql(gql(_templateObject4$1), {
	skip: function skip(ownProps) {
		return !ownProps.restaurant;
	},
	options: function options(ownProps) {
	...
	props: function props(_ref4) {
		...
		return {
			roles: (fp.get(['accountRolesForRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
				return edge.node;
			}),
...
var getOptions = reactApollo.graphql(gql(_templateObject2$7, optionFragment), {
  props: function props(_ref) {
    var ownProps = _ref.ownProps,
        data = _ref.data;
    ...
    return {
      options: getOptions.loading ? [] : (fp.get(['nodes'])(allOptions) || []).map(function (node) {
...
var getMenuItem = reactApollo.graphql(gql(_templateObject4$3, menuItemFragment), {
	skip: function skip(ownProps) {
...
var getMenuItemTypes = reactApollo.graphql(gql(_templateObject5$2, menuItemTypeFragment, menuItemCategoryFragment), {
	props: function props(_ref2) {
		var ownProps = _ref2.ownProps,
		    data = _ref2.data;
		...
		return {
			menuItemTypes: getMenuItemTypes.loading ? [] : (fp.get(['nodes'])(allMenuItemTypes) || []).map(function (node) {
...
var getMenuItemsByRestaurant = reactApollo.graphql(gql(_templateObject6$1, menuItemFragment), {
	skip: function skip(ownProps) {
		return !ownProps.restaurant;
	},
	options: function options(ownProps) {
	...
	props: function props(_ref3) {
		...
		return {
			menuItems: getMenuItemsByRestaurant.loading ? [] : (fp.get(['menuItemsByRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
...
var createMenuItem = reactApollo.graphql(gql(_templateObject$7, menuItemFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
...
var updateMenuItem = reactApollo.graphql(gql(_templateObject2$5, menuItemFragment), {
	props: function props(_ref2) {
		var mutate = _ref2.mutate;
		return {
			updateMenuItem: function updateMenuItem(menuItem) {
				return mutate({ variables: {
						input: { menuItem: fp.omit(['__typename', 'nodeId'])(menuItem) }
					} });
			}
		};
	}
...
var deleteMenuItem = reactApollo.graphql(gql(_templateObject3$4), {
	props: function props(_ref3) {
		var mutate = _ref3.mutate;
		return {
			deleteMenuItem: function deleteMenuItem(menuItem) {
				return mutate({ variables: {
						input: { menuItem: fp.get('id')(menuItem) || menuItem }
					} });
			}
		};
	}
...
var createMenuItemI18n = reactApollo.graphql(gql(_templateObject4$2), {
	props: function props(_ref4) {
...
var updateMenuItemI18n = reactApollo.graphql(gql(_templateObject5$1), {
		...
		return {
			updateMenuItemI18n: function updateMenuItemI18n(menuItemI18nItems) {
				return (Array.isArray(menuItemI18nItems) ? menuItemI18nItems : [menuItemI18nItems]).forEach(function (menuItemI18n) {
					return mutate({ variables: {
							input: {
								menuItemI18n: fp.omit(['__typename', 'nodeId'])(menuItemI18n)
							}
						} });
				});
			}
...
var updateMenuItemImages = reactApollo.graphql(gql(_templateObject6), {
...
var updateMenuItemDiets = reactApollo.graphql(gql(_templateObject7), {
...
var updateMenuItemOptions = reactApollo.graphql(gql(_templateObject8), {
...
var getOrder = reactApollo.graphql(gql(_templateObject3$6, orderFragment), {
	skip: function skip(ownProps) {
	...
	options: function options(ownProps) {
		return {
			variables: {
				id: typeof ownProps.order === 'number' ? ownProps.order : fp.get(['order', 'id'])(ownProps)
			}
		};
	},
	props: function props(_ref) {
...
var getOrdersByRestaurant = reactApollo.graphql(gql(_templateObject4$4, orderFragment), {
	skip: function skip(ownProps) {
		return !ownProps.restaurant;
	},
	options: function options(ownProps) {
	...
	props: function props(_ref2) {
		...
		return {
			orders: getOrdersByRestaurant.loading ? [] : (fp.get(['ordersByRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
...
var getOrdersByAccount = reactApollo.graphql(gql(_templateObject5$3, orderFragment), {
	skip: function skip(ownProps) {
	...
	props: function props(_ref3) {
		...
		return {
			orders: getOrdersByAccount.loading ? [] : (fp.get(['ordersByCreatedBy', 'edges'])(accountById) || []).map(function (edge) {
				return formatOrder(edge.node);
			}),
...
var createOrder = reactApollo.graphql(gql(_templateObject$10, orderFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
...
var updateOrder = reactApollo.graphql(gql(_templateObject2$8, orderFragment), {
	props: function props(_ref2) {
		var mutate = _ref2.mutate;
		return {
			updateOrder: function updateOrder(order) {
				return mutate({ variables: {
						input: {
							order: Object.assign(fp.pick(['id', 'accepted', 'declined', 'completed'])(order), {
...
var getMenu = reactApollo.graphql(gql(_templateObject2$11, menuFragment), {
	skip: function skip(ownProps) {
...
var getMenusByRestaurant = reactApollo.graphql(gql(_templateObject3$8, menuFragment), {
	skip: function skip(ownProps) {
		return !ownProps.restaurant;
	},
	options: function options(ownProps) {
	...
	props: function props(_ref2) {
		...
		return {
			menus: getMenusByRestaurant.loading ? [] : (fp.get(['menusByRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
...
var createMenu = reactApollo.graphql(gql(_templateObject$12, menuFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
...
var updateMenu = reactApollo.graphql(gql(_templateObject2$10, menuFragment), {
	props: function props(_ref2) {
		var mutate = _ref2.mutate;
		return {
			updateMenu: function updateMenu(menu) {
				return mutate({ variables: {
						input: { menu: fp.omit(['__typename', 'nodeId'])(menu) }
					} });
			}
		};
	}
...
var deleteMenu = reactApollo.graphql(gql(_templateObject3$7), {
	props: function props(_ref3) {
		var mutate = _ref3.mutate;
		return {
			deleteMenu: function deleteMenu(menu) {
				return mutate({ variables: {
						input: { menu: fp.get('id')(menu) || menu }
					} });
			}
		};
	}
...
var createMenuI18n = reactApollo.graphql(gql(_templateObject4$5), {
	props: function props(_ref4) {
		var mutate = _ref4.mutate;
		return {
...
var updateMenuI18n = reactApollo.graphql(gql(_templateObject5$4), {
	props: function props(_ref5) {
		var mutate = _ref5.mutate;
		return {
			updateMenuI18n: function updateMenuI18n(menuI18nItems) {
				return (Array.isArray(menuI18nItems) ? menuI18nItems : [menuI18nItems]).forEach(function (menuI18n) {
					return mutate({ variables: {
							input: {
								menuI18n: fp.omit(['__typename', 'nodeId'])(menuI18n)
							}
						} });
				});
			}
...
var updateMenuItems = reactApollo.graphql(gql(_templateObject6$2), {
	props: function props(_ref6) {
		var mutate = _ref6.mutate;
		return {
...
var getServingLocation = reactApollo.graphql(gql(_templateObject2$13, servingLocationFragment), {
	skip: function skip(ownProps) {
...
var getServingLocationsByRestaurant = reactApollo.graphql(gql(_templateObject3$9, servingLocationFragment), {
	skip: function skip(ownProps) {
		return !ownProps.restaurant;
	},
	options: function options(ownProps) {
	...
	props: function props(_ref2) {
		...
		return {
			servingLocations: getServingLocationsByRestaurant.loading ? [] : (fp.get(['servingLocationsByRestaurant', 'edges'])(restaurantById) || []).map(function (edge) {
...
var createServingLocation = reactApollo.graphql(gql(_templateObject$14, servingLocationFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
...
var updateServingLocation = reactApollo.graphql(gql(_templateObject2$12, servingLocationFragment), {
	props: function props(_ref2) {
		var mutate = _ref2.mutate;
		return {
			updateServingLocation: function updateServingLocation(servingLocation) {
				return mutate({ variables: {
						input: { servingLocation: fp.omit(['__typename', 'nodeId'])(servingLocation) }
					} });
			}
		};
	}
...
var createRestaurant = reactApollo.graphql(gql(_templateObject$16, restaurantFragment), {
	props: function props(_ref) {
		var mutate = _ref.mutate;
		return {
...
var createRestaurantI18n = reactApollo.graphql(gql(_templateObject2$14, restaurantI18nFragment), {
	props: function props(_ref2) {
		var mutate = _ref2.mutate;
		return {
				...
				(Array.isArray(items) ? items : [items]).forEach(function (restaurantI18n) {
					return mutate({
						...
						update: function update(store, _ref3) {
							...
							var oldI18n = fp.get(['restaurantById', 'restaurantI18nsByRestaurant', 'nodes'])(oldRestaurant);
							// should push translation to i18n, if it doesn't already exists
							if (!fp.find(function (i) {
								return i.language === restaurantI18n.language;
							})(oldI18n)) {
								store.writeQuery({
									query: getRestaurantQuery,
									data: fp.set(['restaurantById', 'restaurantI18nsByRestaurant', 'nodes'])(oldI18n.concat(restaurantI18n))(oldRestaurant)
								});
							}
						}
					});
...
var updateRestaurantI18n = reactApollo.graphql(gql(_templateObject3$10, restaurantI18nFragment), {
	props: function props(_ref4) {
		var mutate = _ref4.mutate;
		return {
			updateRestaurantI18n: function updateRestaurantI18n(items) {
				return (Array.isArray(items) ? items : [items]).forEach(function (restaurantI18n) {
					return mutate({
						variables: {
							input: {
								restaurantI18n: fp.omit(['__typename', 'nodeId'])(restaurantI18n)
							}
						},
...
var updateRestaurant = reactApollo.graphql(gql(_templateObject4$6, restaurantFragment), {
	props: function props(_ref6) {
		var mutate = _ref6.mutate;
		return {
			updateRestaurant: function updateRestaurant(restaurant) {
				return mutate({
					variables: {
						input: { restaurant: fp.omit(['__typename', 'nodeId'])(restaurant) }
					},
...
var updateRestaurantImages = reactApollo.graphql(gql(_templateObject5$5, imageFragment), {
	props: function props(_ref8) {
		var mutate = _ref8.mutate;
		return {
			updateRestaurantImages: function updateRestaurantImages(restaurant, images) {
				return mutate({
					...
					update: function update(store, _ref9) {
						...
						store.writeQuery({
							query: getRestaurantQuery,
							data: fp.set(['restaurantById', 'restaurantImagesByRestaurant', 'nodes'])(restaurantImages)(old)
						});
					}
				});
			}
					...
					case 0:
						socket.on('notification', function (notification) {
							...
							if (record, table, operations) {
								var target = humps.pascalize(table);
								var object = _extends$2({ __typename: target }, humps.camelizeKeys(record));
...
exports.order = order;
exports.option = option_queries;
exports.servingLocation = servingLocation;
exports.misc = misc;
exports.account = account;
exports.subscribe = subscribe$1;
exports.file = file_queries;
exports.util = file_queries;
